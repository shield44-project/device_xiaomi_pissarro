...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.vendor.audio.device.db=pissarro \
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.mediatek.version.branch=alps-mp-r0.mssi1.tc8sp-mt6877 \
    ro.mediatek.wlan.p2p=1 \
    ro.mediatek.wlan.wsc=1 \
    ro.vendor.mediatek.platform=MT6877 \
    ro.vendor.mediatek.version.branch=alps-mp-r0.mp3.tc8sp-mt6877 \
    ro.vendor.mediatek.version.release=alps-mp-r0.mp3.tc8sp-mt6877-V1_xiaomi.r0mp3.k6877v1.64_P94 \
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.vendor.sensor.cali_sensor=111001110000000 \
    ...
    ro.bootimage.build.date.utc=1646664695 \
    ro.bootimage.build.date=Mon \
    Mar \
    22:51:35 \
    CST \
    2022 \
    ro.bootimage.build.fingerprint=Xiaomi/pissarro/pissarro:11/RP1A.200720.011/V12.5.5.0.RKTINXM:user/release-keys \
    ...
    ro.miui.version.code_time=1643040000 \
    ro.odm.build.date.utc=1646664061 \
    ro.odm.build.date=Mon \
    22:41:01 \
    ro.odm.build.fingerprint=Xiaomi/pissarro/pissarro:11/RP1A.200720.011/V12.5.5.0.RKTINXM:user/release-keys \
    ro.odm.build.id=RP1A.200720.011 \
    ro.odm.build.tags=release-keys \
    ro.odm.build.type=user \
    ro.odm.build.version.incremental=V12.5.5.0.RKTINXM \
    ...
    ro.product.board=pissarro \
    ro.product.build.date.utc=1646664061 \
    ro.product.build.date=Mon \
    ro.product.build.fingerprint=Xiaomi/pissarro/pissarro:11/RP1A.200720.011/V12.5.5.0.RKTINXM:user/release-keys \
    ro.product.build.id=RP1A.200720.011 \
    ro.product.build.tags=release-keys \
    ro.product.build.type=user \
    ro.product.build.version.incremental=V12.5.5.0.RKTINXM \
    ro.product.build.version.release=11 \
    ro.product.build.version.release_or_codename=11 \
    ro.product.build.version.sdk=30 \
    ro.product.manufacturer=Xiaomi \
    ro.product.mod_device=pissarro_in_global \
    ro.product.odm.brand=Xiaomi \
    ro.product.odm.device=pissarro \
    ro.product.odm.manufacturer=Xiaomi \
    ro.product.odm.marketname= \
    ro.product.odm.model=pissarro \
    ro.product.odm.name=pissarro \
    ro.product.product.brand=Xiaomi \
    ro.product.product.device=pissarro \
    ro.product.product.manufacturer=Xiaomi \
    ro.product.product.marketname= \
    ro.product.product.model=pissarro \
    ro.product.product.name=pissarro \
    ro.product.property_source_order=odm,vendor,product,system \
    ro.product.system_ext.brand=Xiaomi \
    ro.product.system_ext.device=pissarro \
    ro.product.system_ext.manufacturer=Xiaomi \
    ro.product.system_ext.marketname= \
    ro.product.system_ext.model=pissarro \
    ro.product.system_ext.name=pissarro \
    ro.product.vendor.brand=Xiaomi \
    ro.product.vendor.device=pissarro \
    ro.product.vendor.manufacturer=Xiaomi \
    ro.product.vendor.marketname= \
    ro.product.vendor.model=pissarro \
    ro.product.vendor.name=pissarro \
    ...
    ro.system_ext.build.date.utc=1646664061 \
    ro.system_ext.build.date=Mon \
    ro.system_ext.build.fingerprint=Xiaomi/pissarro/pissarro:11/RP1A.200720.011/V12.5.5.0.RKTINXM:user/release-keys \
    ro.system_ext.build.id=RP1A.200720.011 \
    ro.system_ext.build.tags=release-keys \
    ro.system_ext.build.type=user \
    ro.system_ext.build.version.incremental=V12.5.5.0.RKTINXM \
    ...
    ro.vendor.aod_layer.check=true \
    ro.vendor.ap_info_monitor=0 \
    ro.vendor.build.date.utc=1646664695 \
    ro.vendor.build.date=Mon \
    ro.vendor.build.id=RP1A.200720.011 \
    ro.vendor.build.security_patch=2021-08-05 \
    ro.vendor.build.software.version=Android11_125 \
    ro.vendor.build.tags=release-keys \
    ro.vendor.build.type=user \
    ro.vendor.build.version.incremental=V12.5.5.0.RKTINXM \
...
# Netflix
PRODUCT_PROPERTY_OVERRIDES += \
    ro.netflix.bsp_rev=MTK6877-33678-1 \
